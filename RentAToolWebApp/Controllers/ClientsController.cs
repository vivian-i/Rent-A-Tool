...
namespace RentAToolWebApp.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var applicationDbContext = _context.Clients.Include(c => c.Address);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PhoneNumber,AddressId")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PhoneNumber,AddressId")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
